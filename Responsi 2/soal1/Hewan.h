...
class Hewan {
    ...
    public:
        ...
        ~Hewan() { cout << "Hewan mati " << name << endl;};
        virtual void print() { cout << "Hewan ini namanya "<< name << endl;}
};

class Anjing : public Hewan {
    public :
        Anjing(string nm) : Hewan(nm) {};
        ~Anjing() { cout << "Anjing mati " << name << endl; }
        void print() { cout << "Anjing ini namanya " << name << endl;}
};

class Kucing : public Hewan{
    public :
        Kucing(string nm) : Hewan(nm) {};
        virtual ~Kucing() { cout << "Kucing mati " << name << endl;};
        //virtual void print() { cout << "Kucing ini namanya " << name << endl; };
};
...
class KucingAnggora : public Kucing{
    ...
    public :
        ...
        ~KucingAnggora() {cout << "Kucing anggora mati " << name << endl;};
...
class AnjingBulldog : public Anjing{
    ...
    public :
        ...
        virtual ~AnjingBulldog() { cout << "Anjing bulldog mati " << name << endl;};
